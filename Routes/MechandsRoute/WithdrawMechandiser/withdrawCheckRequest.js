...
router.get("/batsiraiferhatpay/mechandiserWithdrawCheck", isAuth, (req, res, next) => {
  let userid = req.session.passport.user;
  console.log("/mechandiserWithdrawCheck");

  let sql =
    "SELECT * FROM AgenttransactionsChecker  WHERE AgentID = ? AND WithdrawlTransaction=1 ORDER BY id DESC";
