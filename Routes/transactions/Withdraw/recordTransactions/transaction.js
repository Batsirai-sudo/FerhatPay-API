...
function recordTransactions(posted,initialBalance,finalBalance,user, callback) {
    ...
    const withdraw_transaction_amount = obj.totaltransaction;
    const withdraw_status = obj.transactionStatus;
  ...
  let topUpTransactionData = {
    ...
    TransactionDescription: transaction_description,
            ...
            Amount: withdraw_transaction_amount,
  ...
  let sql = "INSERT INTO withdrawTransactions SET ?";
  dbConnect.query(sql, [topUpTransactionData], (error, transactionresults) => {
    ...
    if (transactionresults) {
        ...
        topUpTransactionData.TransactionType = 'Withdraw'
